...
using MVCforDevartIdentity2.Models; 
...
namespace MVCforDevartIdentity2.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            var linkedAccounts = UserManager.GetLogins<ApplicationUser,string>(User.Identity.GetUserId());
            ...
            bool isPersistent)
        {
            ...
            AuthenticationManager.SignIn(new AuthenticationProperties { IsPersistent = isPersistent },
                 await UserManager.GenerateUserIdentityAsync(user));
